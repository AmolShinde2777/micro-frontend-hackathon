  ...
  methods: {
    submit: function () {
      ...
      if (this.editFlagProp) {
        ...
        fetch("http://localhost:3000/studentData/" + this.idProp, requestOptions).then(response => response.json()).then(data => this.idProp = data.id);
        ...
        if (this.valid) {
          ...
          fetch("http://localhost:3000/studentData", requestOptions).then(response => response.json()).then(data => this.id = data.id);
          this.$emit("submit", "fromvueapp");
        }
      }
    ...
    fetchData: function (value) {
      fetch("http://localhost:3000/studentData/" + value).then(response => response.json()).then(data => this.setData(data));
